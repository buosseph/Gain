...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright BrianUosseph, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Gain-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Gain-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Gain-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Gain-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Gain-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Gain-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Gain-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Gain.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Gain.iss",inplace=1):
